    ...
    <main className="h-screen">
      ...
      <section
        ...
        <div className="flex space-x-7 relative z-10 justify-center">
          ...
          <DesignStartBox onCreateDesign={handleCreateDesign}  onError={() => setShowErrorAlert1(true)}  disabled={showErrorAlert1} />
          <div
            className={`transition-opacity duration-1000 ease-in-out ${show.selectBox ? 'opacity-100' : 'opacity-0'}`}>
            {!isLoading.create && show.selectBox && <DesignSelectBox onSelectDesign={handleDesignSelection} onRetry={handleRetryDesign} />}
