...
function StatisticContent() {
  return (
    <div className="mt-[3.3125rem] mx-[5.4375rem] flex flex-col items-center">
      <div className="mb-[4.375rem] flex gap-[2.875rem]">
        <select className="w-[9.5rem] h-[3.6875rem] border-[#afafaf] border-[1px] rounded-[15px] shadow-xl flex justify-center items-center gap-[1.6875rem] text-[1.5rem] px-[1rem]">
          <option value="일간">일간</option>
          <option value="주간">주간</option>
        </select>
        <p className="w-[56.3125rem] h-[3.6875rem] border-[#afafaf] border-[1px] rounded-[15px] shadow-xl items-center flex justify-center text-[1.5rem]">
          날짜
        </p>
      </div>
