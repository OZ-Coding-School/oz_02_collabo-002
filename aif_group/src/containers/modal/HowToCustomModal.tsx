  ...
  return (
    <main>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        />
        <button className="w-[10rem] h-[3.5625rem] bg-black group hover:bg-main_active active:bg-main_active flex justify-center items-center rounded-[4px] mb-2">
          <div className='font-bold text-[1.5rem] text-main_active group-hover:text-black group-active:text-black"'>
            창닫기
          </div>
        </button>
      </div>
