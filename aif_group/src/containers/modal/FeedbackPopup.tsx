...
const FeedbackPopup = () => {
  return (
    <div className="w-[75rem] h-[176.875rem] border border-black rounded-[16px] shadow-xl ">
      ...
      <div className="flex flex-col items-center mt-16">
        ...
        <div className="font-bold h-[147.5rem] mt-16">
          <form action="/submit-survey" className="w-[43.8125rem] h-full flex flex-col items-start">
            ...
            <div className="w-full text-center mt-10">
              <p className="text-btn_text text-sm font-normal">
              ...
              <p className="text-lg font-medium">설문 완료시 이미지 다운로드가 자동으로 실행됩니다.</p>

              <button type="submit" className="text-2xl text-main_active bg-black w-[10.8125rem] h-[3.5625rem] mt-10">
                완료
              </button>
            </div>
          </form>
