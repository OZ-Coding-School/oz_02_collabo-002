...
export default function AboutSection() {
  return (
    <main className="w-full h-banner bg-[#E6E6E6] flex justify-center items-center">
      <section className="max-w-[78.5625rem] w-[90%] h-[33.5rem] flex justify-between items-center mx-4">
        <div className="flex flex-col justify-start items-start mr-5">
          ...
          <div className="max-w-[42.5rem] min-w-[28rem] h-fit text-[1.375rem] leading-[37px] mt-[5px] mb-[2.4375rem]">
        ...
        <div className="w-[33.5rem] h-[33.5rem] relative">
          <Image
            alt="about_section_image"
            src={'/images/about_section_image.png'}
            fill
            sizes="(min-width: 1200px) 50%, 100%"
