...
export default function AboutSection() {
  return (
    <main className="w-full h-banner md:h-fit bg-[#E6E6E6] flex justify-center items-center">
      <section className="w-[78.5625rem] h-[33.5rem] flex justify-between items-center mx-6 md:flex-col md:h-fit sm:w-[90%]">
        <div className="flex flex-col justify-start items-start mr-5 mt-28 md:mr-0">
          ...
          <div className="lg:max-w-[42.5rem] lg:min-w-[38.625rem] h-fit text-[1.375rem] leading-[37px] mt-[5px] mb-[2.4375rem] md:w-[34rem]">
        ...
        <div className="w-[33.5rem] h-[33.5rem] relative my-14">
          <Image
