...
export default function Footer() {
  return (
    <main className="w-full h-footer flex flex-col justify-center items-center relative">
      <div className="w-3/4 flex justify-between align-top mmd:flex-col-reverse">
        <div className="mr-8">
          <div className="text-[1rem] text-footer_text mb-[15.5px]">AI Fashionista l AI 패셔니스타</div>
          <div className="text-[1rem] text-footer_text">
        ...
        <div className="min-w-[16rem] w-[17rem] h-[2.5rem] flex justify-between items-center space-x-3 mb-7">
          <Link href="https://www.instagram.com/AI_Fashionista__/" rel="noopener noreferrer" target="_blank">
            <Image alt="insta_icon" src={'/icons/insta_icon.svg'} width={40} height={40} className="w-10 h-10" />
          </Link>
          <Link
            href="https://www.youtube.com/channel/UC17QRG75E3NRUMCmk88cioA"
            rel="noopener noreferrer"
            target="_blank">
            <Image alt="youtube_icon" src={'/icons/youtube_icon.svg'} width={40} height={40} className="w-10 h-10" />
          </Link>
          <Link href="http://www.tiktok.com/@ai_fashionista_" rel="noopener noreferrer" target="_blank">
            <Image alt="tiktok_icon" src={'/icons/tiktok_icon.svg'} width={40} height={40} className="w-10 h-10" />
          </Link>
          <Link href="https://open.kakao.com/o/gRTgDRag" rel="noopener noreferrer" target="_blank">
            <Image alt="kakao_icon" src={'/icons/kakao_icon.svg'} width={40} height={40} className="w-10 h-10" />
          </Link>
          <Link href="https://cafe.naver.com/aifashionista" rel="noopener noreferrer" target="_blank">
            <Image alt="naver_icon" src={'/icons/naver_icon.svg'} width={40} height={40} className="w-10 h-10" />
          </Link>
        </div>
      </div>
    </main>
