    ...
    <main className="w-full h-banner bg-[#E6E6E6] flex justify-center items-center">
      <section className="w-full h-[33.1875rem] flex flex-col justify-center items-center ">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="text-[1.3125rem] leading-[37px] tracking-[-0.06em] text-[#555555]">
            AIF 디자인 툴 사용 방법
          </div>
        </div>
        <div className="w-[78.5625rem] h-[23.0625rem] flex justify-between items-center mt-[67px]">
          <div className="w-[13.125rem] h-[23.0625rem] flex flex-col justify-between items-center">
            <Image alt="how_to_custom_1" src={'/images/how_to_custom_1.svg'} width={210} height={212} />
          ...
          <div className="w-1 h-[314px] border-l-[3px] border-white"></div>
          <div className="w-[13.125rem] h-[23.0625rem] flex flex-col justify-between items-center">
            <Image alt="how_to_custom_3" src={'/images/how_to_custom_3.svg'} width={210} height={210} />
            <div className="w-[10.8125rem] h-[7.625rem] flex flex-col justify-between items-center">
              <div className="font-bold text-[1.5rem] leading-[37px] tracking-[-0.06em] flex relative">
                디자인 생성
