  ...
  return (
    <main className="w-full h-banner bg-[#E6E6E6] flex justify-center items-center">
      <section className="w-full h-[33.1875rem] flex flex-col justify-center items-center ">
        ...
        <div className="w-full h-[23.0625rem] flex justify-center items-center mt-[67px]">
          <div className="w-[13.125rem] h-[23.0625rem] flex flex-col justify-between items-center mx-2">
            <Image alt="how_to_custom_1" src={'/images/how_to_custom_1.svg'} width={250} height={253} />
          ...
          <div className="w-[13.125rem] h-[23.0625rem] flex flex-col justify-between items-center mx-2">
            <Image alt="how_to_custom_2" src={'/images/how_to_custom_2.svg'} width={190} height={218} />
            <div className="w-[10.8125rem] h-[7.625rem] flex flex-col justify-between items-center">
          ...
          <div className="w-1 h-[314px] border-l-2 border-white flex justify-center items-center"></div>
          <div className="w-[13.125rem] h-[23.0625rem] flex flex-col justify-between items-center mx-2">
            <Image alt="how_to_custom_3" src={'/images/how_to_custom_3.svg'} width={210} height={210} />
            <div className="w-[10.8125rem] h-[7.625rem] flex flex-col justify-between items-center">
          ...
          <div className="w-1 h-[314px] border-l-2 border-white"></div>
          <div className="w-[13.125rem] h-[23.0625rem] flex flex-col justify-between items-center mx-2">
            <Image alt="how_to_custom_4" src={'/images/how_to_custom_4.svg'} width={170} height={227} />
            <div className="w-[10.8125rem] h-[7.625rem] flex flex-col justify-between items-center">
          ...
          <div className="w-[13.125rem] h-[23.0625rem] flex flex-col justify-between items-center mx-2">
            <Image alt="how_to_custom_5" src={'/images/how_to_custom_5.svg'} width={210} height={228} />
            <div className="w-[10.8125rem] h-[7.625rem] flex flex-col justify-between items-center">
