...
const Question56 = () => {
  ...
  return (
    <div className="max-w-[43.8125rem] w-[90%]">
      ...
      <div className="flex flex-col justify-between items-start bg-input_bg w-full h-[7.3125rem] py-5 px-10 mb-14 sm:pl-7">
        <label className="w-full h-full text-xl text-form_color flex items-center">
          ...
          />
          <span className="peer-checked:text-black sm:text-lg">예</span>
        </label>
        <label className="w-full h-full text-xl text-form_color flex items-center">
          <input
            type="radio"
            ...
            onChange={handleCheckedReasonChange}
          />
          <span className="peer-checked:text-black sm:text-lg">아니오</span>
        </label>
      </div>
      ...
      {selectedValue ? (
        selectedValue === '예' ? (
          <div className="w-full">
            ...
            <div className="bg-input_bg w-full h-[6.25rem] pt-9 mb-14">
              <div className="w-[80%] flex justify-center items-center m-auto">
                <input
                  ...
                  value={reasonText}
                  className="font-normal text-xl bg-input_bg border-b-2 border-form_color w-full sm:text-base"
                />
              </div>
            </div>
          </div>
