  ...
  return (
    <div className="max-w-[43.8125rem] w-[90%]">
      <p className="font-bold text-2xl mb-3 sm:text-xl">
        ...
        <span className="font-normal text-xl ml-1.5 sm:text-lg">(중복선택 가능)</span>
      </p>
      <div className="flex flex-col justify-between items-start space-y-1 bg-input_bg w-full min-h-[18rem] h-fit py-3 pl-10 mb-14 sm:pl-7 sm:py-4 sm:pr-2">
        ...
        <label className="w-full h-full text-xl text-form_color flex items-center">
          <input
            ...
            value={'스타일'}
          />
          <span className="w-[90%] peer-checked:text-black sm:text-lg">AI 이미지 스타일이 다양하면 좋겠다.</span>
        </label>
        <label className="w-full h-full text-xl text-form_color flex items-center">
          <input
            type="checkbox"
        ...
        <label className="w-full h-full text-xl text-form_color flex items-center">
          <input
            ...
            value={'색상'}
          />
          <span className="w-[90%] peer-checked:text-black sm:text-lg">티셔츠 색상이 더 다양하면 좋겠다.</span>
        </label>
        <label className="w-full h-full text-xl text-form_color flex items-center">
          <input
            type="checkbox"
        ...
        <label className="w-full h-full text-xl text-form_color flex items-center relative">
          ...
          />
          <span className="peer-checked:text-black sm:text-lg">
            기타
            <input
              type="text"
              id="otherFeedback"
              ...
              className="font-normal text-base bg-input_bg border-b-2 border-form_color w-[22.25rem] ml-3 absolute bottom-1 sm:w-[70%] sm:text-sm"
            />
          </span>
        </label>
      </div>
